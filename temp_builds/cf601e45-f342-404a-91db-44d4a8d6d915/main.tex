...
\section*{解答}
\begin{itemize}
\item[（1）] \textbf{[因数分解]} \quad $$(x - 3)^2$$
        
\item[（2）] \textbf{[因数分解]} \quad $$(x + 2)^2$$
        
\item[（3）] \textbf{[因数分解]} \quad $$(x - 3)^2$$
        
\item[（4）] \textbf{[因数分解]} \quad $$(x - 9)^2$$
        
\item[（5）] \textbf{[因数分解]} \quad $$(x - 9)^2$$
        
\item[（6）] \textbf{[因数分解]} \quad $$(x + 4)^2$$
        
\item[（7）] \textbf{[因数分解]} \quad $$(x - 4)^2$$
        
\item[（8）] \textbf{[因数分解]} \quad $$(x - 9)^2$$
        
\item[（9）] \textbf{[因数分解]} \quad $$(x + 8)^2$$
        
\item[（10）] \textbf{[因数分解]} \quad $$(x - 4)^2$$
        \end{itemize}
