...
\begin{itemize}
\item[（1）] \textbf{[一次方程式]} \quad $$x = ${b_a}$$
        
\item[（2）] \textbf{[一次方程式]} \quad $$x = ${b_a}$$
        
\item[（3）] \textbf{[一次方程式]} \quad $$x = ${b_a}$$
        
\item[（4）] \textbf{[一次方程式]} \quad $$x = ${b_plus_a}$$
        
\item[（5）] \textbf{[一次方程式]} \quad $$x = ${b_plus_a}$$
        
\item[（6）] \textbf{[一次方程式]} \quad $$x = ${b_plus_a}$$
        
\item[（7）] \textbf{[一次方程式]} \quad $$x = ${b_plus_a}$$
        
\item[（8）] \textbf{[一次方程式]} \quad $$x = ${b_a}$$
        \end{itemize}
